...
<div class="card">
  <div class="table-responsive">
    <table class="table table-sm table-hover align-middle mb-0" data-sortable>
      <thead>
        <tr><th>IP</th><th class="text-end sortable" data-sort>Downloads</th><th class="text-end sortable" data-sort>Requests</th><th>Last seen</th></tr>
      </thead>
      <tbody>
      <?php foreach ($ips as $r): ?>
        <tr>
          <td class="text-nowrap"><?= h($r['ip']) ?></td>
          <td class="text-end fw-semibold" data-value="<?= (int) $r['downloads'] ?>"><?= number_format((int) $r['downloads']) ?></td>
          <td class="text-end" data-value="<?= (int) $r['requests'] ?>"><?= number_format((int) $r['requests']) ?></td>
